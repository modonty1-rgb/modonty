...
/**
 * Next's own default (rule 2). Exported because anything that must reproduce this
 * component's `/_next/image?url&w&q` key — the hero preloader — has to read the same
 * number instead of copying it. A copied 100 once missed every key it built.
 */
export const DEFAULT_IMAGE_QUALITY: QualityValue = 75;
...
export const SIZE_PRESETS = {
  ...
  /** Client page hero: full width until the 1128px container, then its inner width. */
  clientHero: "(max-width: 1128px) 100vw, 1096px",
...
interface BaseProps {
  ...
  /** Defaults to `DEFAULT_IMAGE_QUALITY`. Must be listed in `images.qualities`. */

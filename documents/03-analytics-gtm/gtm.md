...
Single GTM container tracking all clients by pushing client context to dataLayer. GA4 custom dimensions for client segmentation.
...
- `pushClientContext(clientData)` - Push client info
...
- `app/articles/[slug]/page.tsx` - Push client context
- `app/clients/[slug]/page.tsx` - Push client context
...
/ → No client (platform-level tracking)
```

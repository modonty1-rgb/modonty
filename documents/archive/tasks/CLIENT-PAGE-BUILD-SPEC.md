...
>
> - **العقد البصري (شكل الصفحة):** `documents/archive/tasks/client-page-light-mockup.html` — **BUILD 15**.
...
| الغرض | المسار |
|---|---|
| العقد البصري (الموكب) | `documents/archive/tasks/client-page-light-mockup.html` (BUILD 15) |

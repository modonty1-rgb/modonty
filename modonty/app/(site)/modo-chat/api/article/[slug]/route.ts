...
import { chunkArticleContent } from "@/app/(site)/modo-chat/helpers/rag-chunk";
import { retrieveFromChunks } from "@/app/(site)/modo-chat/helpers/rag-retrieve";
import { isOutOfScope, isGreetingOrShortPleasantry } from "@/app/(site)/modo-chat/helpers/rag-scope";
import { buildArticleDbPrompt, buildArticleWebPrompt, hasTrustedContent } from "@/app/(site)/modo-chat/helpers/rag-prompts";
import { chatStream, rerank, type ChatMessage } from "@/app/(site)/modo-chat/helpers/cohere";
import { searchSerper } from "@/app/(site)/modo-chat/helpers/serper";
import { saveChatbotMessage } from "@/app/(site)/modo-chat/helpers/save-chatbot-message";
...
export async function POST(
  ...
  try {
    ...
    if (!wantStream) {
      const { chat } = await import("@/app/(site)/modo-chat/helpers/cohere");

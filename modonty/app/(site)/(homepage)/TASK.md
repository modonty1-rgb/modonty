...
## ✅ نُفِّذ — صفّ المجالات في الجوّال (٢١ أغسطس ٢٠٢٦)

- العنوان: **«استكشف المجالات»**، ومعه رابط **«عرض الكل»** في الجهة المقابلة.
- صفّ RTL ديناميكي من بيانات `industries`: اسم المجال وصورته، مع رمز مناسب كبديل عند غياب الصورة.
- لا يتكرر رسم مودو على كل مجال؛ لكل مجال صورة أو رمز بصري يميّزه قبل قراءة الاسم.
- يظهر نحو **٢٫٣–٢٫٧ بطاقة** في عرض الهاتف، مع جزء من البطاقة التالية في اليسار كإشارة للسحب.
- البطاقات موحّدة النسبة والحواف والمسافة، والنص لا يُقص، وهدف اللمس لا يقل عن ٤٤ بكسل.
- حالة الشريحة الحالية تُبرز بهدوء، ومؤشر تقدّم صغير يحلّ محل شريط تمرير المتصفح الظاهر.
- التصميم داكن وهادئ من ألوان مدونتي: كحلي قريب من الأسود، أسطح أفتح قليلاً، ولمسات نيلي وسماوي مقيدة.
- المرجع المولّد للإلهام فقط؛ التنفيذ يبقى بمكوّنات المشروع وبياناته الحقيقية، لا بصورة ثابتة.
- التنفيذ: `components/industries-card/IndustriesCarousel.tsx`، مع بقاء رِيل الديسكتوب كما هو.

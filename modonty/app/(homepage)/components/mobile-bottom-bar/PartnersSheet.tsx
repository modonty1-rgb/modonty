...
import { SortMenu } from "@/app/(homepage)/components/mobile-bottom-bar/SortMenu";
...
interface PartnersSheetProps {
  partners: FilterOption[];
  activeClient?: string;
  onClose: () => void;
}

export function PartnersSheet({ partners, activeClient, onClose }: PartnersSheetProps) {

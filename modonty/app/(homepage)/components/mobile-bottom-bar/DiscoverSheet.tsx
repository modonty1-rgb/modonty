...
// Lazy-loaded on first open (dynamic import in BottomBarShell) → this Sheet's
...
export function DiscoverSheet({ categories, industries, tags, activeCategory, onClose }: DiscoverSheetProps) {
  return (

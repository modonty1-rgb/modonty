...
export async function POST(
  ...
  console.log('====================================');
  console.log('[API ENTRY] /api/comments/[id]/dislike POST handler called');
  ...
  try {
    ...
    console.log('[Comment Dislike API]', { commentId, userId, timestamp: new Date().toISOString() });
    ...
    console.log('[Comment Dislike API] Existing dislike:', existingDislike ? 'YES' : 'NO', 'Existing like:', existingLike ? 'YES' : 'NO');
    ...
    if (existingDislike) {
      ...
      console.log('[Comment Dislike API] Action: REMOVED dislike');
    } else {
      if (existingLike) {
      ...
      console.log('[Comment Dislike API] Action: ADDED dislike');
    }
    ...
    console.log('[Comment Dislike API] Result:', { likesCount, dislikesCount, userDisliked: !existingDislike });

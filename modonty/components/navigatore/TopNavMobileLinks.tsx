...
// Kept minimal on mobile — only search here. الرئيسية = logo · الشركاء = bottom bar ·
// الرائجة = moved into the ⋮ menu (avoid crowding the top bar with duplicate entry points).
const items = [

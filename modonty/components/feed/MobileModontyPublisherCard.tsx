...
interface MobileModontyPublisherCardProps {
  articles: FeedPost[];
...
function MobilePublisherBrand({ brandLogoUrl }: MobilePublisherBrandProps) {
  ...
  return <OptimizedImage media={asMedia(getOptimizedLogoUrl(brandLogoUrl), "مدونتي")} alt="مدونتي" width={56} height={16} sizes="56px" className="h-4 w-14 object-contain" />;
}

export function MobileModontyPublisherCard({ articles, brandLogoUrl }: MobileModontyPublisherCardProps) {

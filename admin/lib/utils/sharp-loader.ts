...
/**
 * The ONE way to get `sharp` in this app.
 *
 ...
 * A plain Node require rooted in a dedicated server-only module (the same path tsx and
 * Vercel use) loads it reliably. Cached after the first call.
 */

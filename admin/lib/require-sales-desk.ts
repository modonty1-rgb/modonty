 ...
 *
 * ── ما يحرسه ──
 * تأكيدُ الحوالة · إلغاءُ طلبٍ لم يصل فيه مال · إصدارُ الفاتورة · إرسالُها ·
 * **تعديلُ الطلب**. وجامعُها أنّها **متابعةُ صفقةٍ مع مشترٍ بعينه** — شغلُ مَن يكلّمه
 * ويرى إيصاله.
 *
 * تعديلُ الطلب انضمّ إليها في نفس اليوم بعد أن كان خارجَها (خالد ٢٠ سبتمبر ٢٠٢٦،
 * مساءً: «زرّ المراجعة والتعديل للـsales ما يظهر، خلّيه يظهر للأدمن وللمبيعات»).
 * والحجّةُ أنّ المندوبَ هو مَن أنشأ الطلبَ ومَن يكتشف الخطأ فيه أوّلاً، فإرسالُه
 * للأدمن ليصحّح رقماً كتبه هو تعطيلٌ لا ضبط.
 *
 * ── وما لا يحرسه ──
 * الأسعارُ والباقات · **تسجيلُ الاسترداد**. تلك قراراتٌ تغيّر الإيراد أو تسعيرَ المنصّة
 * كلِّها، وتبقى لـ`requireFinanceAdmin` — أي مديرِ النظام وحده (خالد ٢٠ سبتمبر ٢٠٢٦:
 * «نفس اللي عملناه أوّل، الاسترداد بس للأدمن»).
 *

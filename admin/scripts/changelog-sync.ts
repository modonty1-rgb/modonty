...
const CHANGELOG: Entry[] = [
  ...
  },
  {
    version: "0.42.0",
    releasedAt: "2026-04-24",
    title: "فلتر سجل التحديثات يشمل الـ items داخل كل إصدار",
    items: [
      { type: "fix", text: "الفلتر (جديد/إصلاح/تحسين) يخفي الـ items غير المطابقة داخل كل card — لا يكتفي بفلترة الـ cards فقط" },
    ],
  },
  {
    version: "1.14.0",
    releasedAt: "2026-08-09",
    title: "مقالات العملاء — الرحلة كاملة حتى موقع العميل",
    items: [
      { type: "feature", text: "مقال يُكتب في مودونتي ويُنشر على موقع العميل نفسه — رحلة كاملة من الكتابة حتى العرض عنده" },
      { type: "feature", text: "عنوان سحب بلا مفتاح: معرّف العميل في المسار نفسه، وخريطة مقالاته نستضيفها عندنا" },
      { type: "feature", text: "لوحة العميل في الكونسول تعرض مقالاته وعنوان السحب جاهزاً للنسخ" },
      { type: "improve", text: "البطاقة المهيكلة لمقال العميل لا تحمل خطّ تنقّل — لا نصف ما لا نراه على موقعه (قاعدة قوقل)" },
      { type: "improve", text: "حارس يمنع حذف أو أرشفة مقال منشور على موقع العميل — حذفه يكسر صفحة شغّالة عنده" },
      { type: "improve", text: "حارس يمنع الروابط الداخلية اليدوية في مقال العميل — الربط من تبويب Related" },
      { type: "fix", text: "عنوان نشر لا يجتاز الفحص لا يُخزَّن، والنشر يُطفأ معه — لا رابط أساسي مكسور في صفحة منشورة" },
    ],
  },
  {
    version: "1.33.0",
    releasedAt: "2026-09-06",
    title: "تقارير الحملات — نفس التجربة لمدونتي وجبر سيو",
    items: [
      { type: "feature", text: "تقرير مدونتي صار بنفس تجربة جبر سيو: فلتر فترة ومنصّة، ملخّص، وأكورديون لكل حملة — بدل جدول عريض بلا فلتر كان يعلق دائماً على شهر فارغ" },
      { type: "fix", text: "رقم العملة كان يلتصق بالوحدة بلا مسافة (تعارض بين الأرقام العربية والنص اللاتيني) — أُصلح في كل صفحات التقرير" },
      { type: "improve", text: "loading.tsx وerror.tsx على تقارير الحملات — كانت الصفحة بلا أي منهما رغم ٣ نداءات مباشرة لـMeta في كل تحميل" },
      { type: "improve", text: "أسماء العلامات ومسار التنقّل صارت عربية بالكامل في شاشات الحملات، بدل أحرف إنجليزية كبيرة وسط جملة عربية" },
    ],
  },
];
// ─────────────────────────────────────────────────────────────────────────────

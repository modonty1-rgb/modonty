// The Google "G" — the ONE icon that marks SEO everywhere in the admin (score chips,
// the clients-table SEO column, the SEO guide). Multicolor brand mark so it reads as
// "Google / search" on any theme, replacing the earlier mix of lens / "SEO" text.

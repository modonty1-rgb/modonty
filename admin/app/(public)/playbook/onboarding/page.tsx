...
const onboardingStages = [
  {
    ...
    items: [
      "اقرأ دليل الفريق كاملاً (/playbook)",
      "احفظ الـ Big Idea: «حضور لا وعود»",
      "اقرأ القواعد الذهبية الـ 22 (/playbook/sales/golden-rules)",
  ...
  },
  {
    ...
    items: [
      ...
      "اطّلع على المواد المرجعية: الهوية، وشرائح العملاء، ودليل المبيعات.",
...
const roles = [
  {
    ...
    items: [
      ...
      "اقرأ /playbook/design/brand قبل أي تصميم",
    ],
    cta: { href: "/playbook#identity", label: "الهوية والصوت" },
  },
  {
    icon: PenLine,
    name: "كاتب المحتوى",
    ...
    cta: { href: "/playbook/content/article-journey", label: "دليل المقالات" },
  },
  {
    icon: Search,
    name: "متخصص SEO",
    ...
    cta: { href: "/playbook/tech/search-preview", label: "معاينة البحث" },
  },
  {
    icon: Target,
    name: "المبيعات",
    ...
    cta: { href: "/playbook/sales/scripts", label: "دليل المبيعات" },
  },
] as const;
...
const onboardingChecklist = [
  "قرأت دليل الفريق كاملاً (/playbook)",
  ...
  "قرأت /playbook/sales/who-we-serve (الـ 7 ICPs + 7 نقاط ألم + Egypt-Gulf tier)",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ابدأ يومك بـ{" "}
                <a href="/playbook/sales/golden-rules" className="text-primary font-semibold hover:underline">

...
ROI = ${roiMultiplier}x`;
  ...
  return (
    <DocLayout
      ...
      description="عشرون قاعدة لا تُكسر: الجملة التي تُقال، وسبب أهميتها."
    >
      {/* ── Hero ─────────────────────────────────────────────────── */}
...
{roiPreBlock}
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          >
            <div className="space-y-3">
              {/* شرح الفلسفة نفسه انتقل إلى «ما هي مدونتي؟» — هنا استعمالها في مكالمة فقط. */}
              <div className="rounded-md border border-emerald-500/25 bg-emerald-500/[0.05] p-4">
                <p className="text-sm leading-relaxed">
                  هذه القاعدة تطبيقٌ بيعيّ لفلسفة مدونتي. الفلسفة نفسها — الحديث ومعناه وكيف ينطبق
                  علينا — مشروحة مرّة واحدة في{" "}
                  <a href="/playbook" className="font-semibold text-primary hover:underline">
                    ما هي مدونتي؟
                  </a>
                  . اقرأها هناك، واستعملها هنا.
                </p>
              </div>

 ...
 */
export function ClientSetupSection() {
  return (
    <section id="client-setup" className="scroll-mt-6">
      {/* كانت ترويسة صفحة مستقلّة بشارة PLAYBOOK وجملة «هذه الصفحة للتشغيل» — وهي الآن قسمٌ داخل المبيعات. */}
      <header id="overview" className="scroll-mt-6 rounded-lg border bg-card p-3">
        <h3 className="text-[17px] font-bold">كيف يبدأ الشريك معنا؟</h3>
        <p className="mt-2 max-w-4xl text-sm leading-6 text-muted-foreground">
          من يستلم، وما الذي يجمعه، وما الذي يسلّمه — حتى يكتمل ملفّ الشريك ويبدأ الإنتاج.
        </p>
      ...
      <section id="workflow" className="mt-4 scroll-mt-6">
      ...
      <section id="client-data" className="mt-4 scroll-mt-6">
        ...
        <div className="mt-2.5 grid gap-2 lg:grid-cols-[1.1fr_0.9fr]">
          <article className="rounded-lg border bg-card p-2.5">
            ...
            <p className="mt-2 flex items-start gap-2 rounded-md bg-amber-500/10 p-2.5 text-[12.5px] leading-6 text-amber-900 dark:text-amber-200">
          ...
          <article id="verified" className="scroll-mt-6 rounded-lg border bg-card p-2.5">
            <div className="flex items-center gap-2 border-b pb-2.5">
            ...
            <p className="mt-2 flex items-start gap-2 rounded-md border border-primary/15 bg-primary/[0.05] p-2.5 text-[12.5px] leading-6">
      ...
      <section id="handoff" className="mt-4 scroll-mt-6">
        <SectionHead title="التسليم التالي" hint="ما الذي يحدث بعد اكتمال ملف الشريك." />
        <p className="mt-2.5 flex items-start gap-2 rounded-lg border border-dashed bg-muted/20 p-2.5 text-[13.5px] leading-6 text-muted-foreground">

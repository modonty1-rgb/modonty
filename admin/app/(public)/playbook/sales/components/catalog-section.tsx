...
export function CatalogSection() {
  return (
    <section id="catalog" className="scroll-mt-6">
      <h3 className="text-[17px] font-bold leading-6">الخدمات وحدود الباقة</h3>
      <p className="mt-1.5 text-[13px] leading-6 text-muted-foreground">خمس خدمات: ما ينفّذه الفريق، وما يقرّره الشريك، وأين يقف حدّ الباقة.</p>
      <div className="mt-2.5 space-y-2.5">
    <section className="mt-4 scroll-mt-6" id="catalog-services">
      <div className="mt-2.5 grid gap-2 xl:grid-cols-2">
        {serviceCatalog.map((service) => (
          <article key={service.title} className="rounded-lg border bg-card p-2.5">
            ...
            <dl className="mt-2 space-y-1.5 text-[13.5px]">
              ...
              <div className="flex gap-2 rounded-md bg-muted/50 p-2.5">
    ...
    <section className="mt-4 scroll-mt-6" id="page">
      ...
      <div className="mt-2.5 grid gap-2 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <article className="rounded-lg border bg-card p-2.5">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pr-4 text-[13.5px] leading-6 text-muted-foreground marker:text-foreground/40">

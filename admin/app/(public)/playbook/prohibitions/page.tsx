...
const seoProhibitions: ProhibitionCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "غياب HTTPS — أو صفحة فيها mixed content", consequence: "HTTPS = القفل الأخضر في المتصفح. جوجل يعتبره من إشارات الترتيب الرسمية. مدونتي على HTTPS حالياً، لكن أي صفحة تحمّل صور أو scripts من رابط HTTP (mixed content) تفقد القفل الأخضر وتنزل من إشارة Page Experience", severity: "high" },
    ],
  },
];
...
export default function ProhibitionsGuidelinePage() {
  return (
    ...
    >
      ...
      {/*
        ممنوعات البيع — نُقلت من `/playbook` في ١٢ سبتمبر ٢٠٢٦ بقرار خالد.
        كانت بطاقةً في زاوية «دفتر الوعود» بحجم بطاقة «قيد البناء» نفسه، وهي أخطر ما في
        الصفحة: جملةٌ تُقال للعميل فتصير التزاماً لا نملك الوفاء به. ومكانها الطبيعي هنا،
        حيث بقيّة الممنوعات — وإن كانت تلك تقنية وهذه بيعية.
      */}
      <section id="sales-limits" className="scroll-mt-6 space-y-3">
        <div>
          <h2 className="text-lg font-bold">ممنوعات البيع — ما لا يُقال للعميل</h2>
          <p className="mt-1 text-[13px] leading-6 text-muted-foreground">
            بقيّة هذه الصفحة ممنوعات تقنية تضرّ الموقع. وهذه ممنوعات قول: جملةٌ تُقال في
            مكالمة فتصير وعدًا لا نملك الوفاء به.
          </p>
        </div>
        ...
        <Card className="border-red-500/35 bg-red-500/[0.05]">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[15px] font-bold">خطوط حمراء: لا تُقال أبدًا</h3>
            </div>
        ...
        <Card className="border-amber-500/35 bg-amber-500/[0.05]">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              <Wrench className="h-4.5 w-4.5 text-amber-400" />
              <h3 className="text-[15px] font-bold">قيد البناء: يُقال كخطة، لا كخدمة قائمة</h3>
            </div>
            <ul className="mt-3 space-y-2 text-[13.5px] leading-7 text-muted-foreground">
              {[
        ...
        <Card className="border-primary/30 bg-primary/[0.04]">
          <CardContent className="p-4 text-[13.5px] leading-7 text-muted-foreground">
            <b className="text-foreground">القاعدة:</b> إن كان الوعد شيئًا تفعله المنصّة أو يفعله
            الفريق أو يقرّره الشريك، فسمّه باسمه. وإن كان قيد البناء، فقله كخطة. وإن كان نتيجةً
            لا نتحكّم فيها، فلا تعد به.
          </CardContent>
        </Card>
      </section>

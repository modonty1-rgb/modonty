...
export const PEOPLE: Person[] = [
  { id: "khaled", name: "خالد", role: "المدير التنفيذي", dept: "الإدارة" },
  { id: "faten", name: "فاتن", role: "المبيعات وعلاقات الشركاء — من أوّل لمسة إلى التجديد", dept: "المبيعات" },
  { id: "amani", name: "أماني", role: "الحملات المدفوعة وقياسها", dept: "التسويق" },
  { id: "maryam", name: "مريم", role: "أورجانك المنصّات والنشرة", dept: "التسويق" },
  { id: "tareq", name: "طارق", role: "قائد المحتوى — ويكتب أيضاً", dept: "المحتوى" },
  { id: "yasmin", name: "ياسمين", role: "كاتبة", dept: "المحتوى" },
  { id: "maya", name: "مايا", role: "كاتبة", dept: "المحتوى" },
  { id: "mustafa", name: "مصطفى", role: "تصميم", dept: "الإنتاج البصري" },
  { id: "mohamed", name: "محمد", role: "مونتاج", dept: "الإنتاج البصري" },
  { id: "rawan", name: "روان", role: "الموجز وتشغيل ملفّ الشريك", dept: "التشغيل" },
];
 ...
 */
export type RoleAsk = { who: string; question: string; answer: string };
...
export const DUTIES: Duty[] = [
  ...
  { n: 8, t: "إصدار الفاتورة بعد الإقفال", stage: "money", owner: "khaled" },
  ...
  { n: 59, t: "تطوير المنصّة وإصلاح الأعطال", stage: "tech", owner: "khaled" },
  { n: 60, t: "مراقبة أخطاء النظام والردّ عليها", stage: "tech", owner: "khaled" },
  { n: 61, t: "النشر والتحديثات ووضع الصيانة", stage: "tech", owner: "khaled" },
  { n: 62, t: "النسخ الاحتياطي وسلامة قاعدة البيانات", stage: "tech", owner: "khaled" },
  { n: 63, t: "التخزين والوسائط الخارجية", stage: "tech", owner: "khaled" },
  ...
  { n: 66, t: "مراجعة أسئلة الشات بوت وتحسين ردوده", stage: "support", owner: "khaled" },
  { n: 67, t: "دعم الشريك حين يتعطّل عليه الكونسول", stage: "support", owner: "khaled", note: "عطل تقني — غير دعم تعبئة البيانات (١٤)" },
  ...
  { n: 79, t: "تصدير البيانات عند الطلب", stage: "reports", owner: "khaled" },
  ...
  { n: 96, t: "إدارة الأعضاء والصلاحيات", stage: "perms", owner: "khaled" },
  ...
  { n: 101, t: "الردّ على توقّف المنصّة أو عطلها الحرج", stage: "loop", owner: "khaled" },
  ...
  { n: 108, t: "الأمن والوصول لقاعدة الإنتاج", stage: "admin", owner: "khaled" },

...
const seoProhibitions: ProhibitionCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "استخدام صور أو نصوص بدون إذن (Copyright / DMCA)", consequence: "صور بدون ترخيص، اقتباسات طويلة بدون إذن، أو إعادة نشر محتوى محمي = طلبات قانونية متراكمة + جوجل يخفّض الموقع. كل صورة في مودونتي لازم ترفعها أنت من مصدر مرخّص — لا سحب من جوجل", severity: "high" },

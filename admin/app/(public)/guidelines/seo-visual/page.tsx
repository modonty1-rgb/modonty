...
export default function SeoVisualPage() {
  return (
    <GuidelineLayout
      ...
      description="كيف يظهر موقعك في جوجل والمنصات — دليل بصري شامل لكل عنصر ومصدره في الأدمن"
    >
      ...
      <Card>
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-6 h-6 rounded-full bg-sky-500/20 border border-sky-500/40 flex items-center justify-center text-[10px] font-bold text-sky-400 shrink-0">١</span>
            ...
            <div className="space-y-3">
              <div className="rounded-lg border border-s-4 border-sky-500/30 border-s-sky-500 bg-sky-500/[0.04] p-3">
                <div className="flex items-center gap-2 mb-1.5">
                  <span className="w-5 h-5 rounded-full bg-sky-500/20 border border-sky-500/40 flex items-center justify-center text-[10px] font-bold text-sky-400 shrink-0">①</span>
                  <span className="text-xs font-bold text-sky-400">الـ Slug — رابط المقال في جوجل</span>
                </div>
                <p className="text-[11px] text-muted-foreground leading-relaxed ps-7">
                  هذا الجزء من الرابط هو ما يقرأه جوجل لفهم موضوع الصفحة. يكتبه النظام تلقائياً من عنوان المقال — لكن راجعه وتأكد أنه بالإنجليزي وبه كلمات مفتاحية.
                </p>
                <div className="mt-2 ps-7 flex items-center gap-1.5">
                  <span className="text-[9px] text-muted-foreground">مصدره في الأدمن:</span>
                  <code className="text-[9px] bg-muted border border-border rounded px-1.5 py-0.5">Basic → Slug</code>
                </div>
              </div>

              <div className="rounded-lg border border-s-4 border-violet-500/30 border-s-violet-500 bg-violet-500/[0.04] p-3">
                <div className="flex items-center gap-2 mb-1.5">
                  <span className="w-5 h-5 rounded-full bg-violet-500/20 border border-violet-500/40 flex items-center justify-center text-[10px] font-bold text-violet-400 shrink-0">②</span>
                  <span className="text-xs font-bold text-violet-400">SEO Title — العنوان الأزرق في جوجل</span>
                </div>
                <p className="text-[11px] text-muted-foreground leading-relaxed ps-7">
                  أول شيء يقرأه الزائر. يختلف عن عنوان المقال داخل الموقع — هذا مكتوب خصيصاً لجوجل. 50-60 حرف مثالي. ضع الكلمة المفتاحية في البداية.
                </p>
                <div className="mt-2 ps-7 flex items-center gap-1.5">
                  <span className="text-[9px] text-muted-foreground">مصدره في الأدمن:</span>
                  <code className="text-[9px] bg-muted border border-border rounded px-1.5 py-0.5">SEO → SEO Title</code>
                </div>
              </div>

              <div className="rounded-lg border border-s-4 border-amber-500/30 border-s-amber-500 bg-amber-500/[0.04] p-3">
                <div className="flex items-center gap-2 mb-1.5">
                  <span className="w-5 h-5 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center text-[10px] font-bold text-amber-400 shrink-0">③</span>
                  <span className="text-xs font-bold text-amber-400">Meta Description — الوصف تحت العنوان</span>
                </div>
                <p className="text-[11px] text-muted-foreground leading-relaxed ps-7">
                  هذا النص يقنع الزائر بالنقر أو يتجاهل الرابط. 140-160 حرف. إذا تركته فارغاً — جوجل يكتب هو ما يراه مناسباً وغالباً لا يكون مقنعاً.
                </p>
                <div className="mt-2 ps-7 flex items-center gap-1.5">
                  <span className="text-[9px] text-muted-foreground">مصدره في الأدمن:</span>
                  <code className="text-[9px] bg-muted border border-border rounded px-1.5 py-0.5">SEO → SEO Description</code>
                </div>
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-6 h-6 rounded-full bg-sky-500/20 border border-sky-500/40 flex items-center justify-center text-[10px] font-bold text-sky-400 shrink-0">٢</span>
            <span className="text-sm font-semibold">البطاقة المُحسَّنة — ما يُضيفه Schema / JSON-LD تلقائياً</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="rounded-xl border border-border/60 bg-background overflow-hidden shadow-sm">
              <div className="px-4 py-2 bg-muted/30 border-b border-border/30 flex items-center gap-2">
                ...
                <span className="text-[10px] text-muted-foreground">نتيجة مُحسَّنة — Article Rich Result</span>
              </div>
              <div className="p-5 space-y-2.5">
                ...
                <div className="pt-1 border-t border-border/30 flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] text-muted-foreground">عيادات بلسم الطبية — Organization</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <p className="text-[11px] text-muted-foreground mb-3 leading-relaxed">
                كل عنصر في هذه البطاقة يُولَّد تلقائياً من بيانات الأدمن — بدون أي كود يدوي:
              </p>
              <div className="space-y-2">
                {[
                  { element: "تسلسل Breadcrumb (Modonty › مقالات › ...)", source: "Settings + Category Slug", color: "text-emerald-400", bg: "bg-emerald-500/[0.05] border-emerald-500/20" },
                  { element: "العنوان الأزرق الكبير", source: "SEO → SEO Title", color: "text-blue-400", bg: "bg-blue-500/[0.05] border-blue-500/20" },
                  { element: "اسم الكاتب وصورته", source: "Authors → Full Name", color: "text-violet-400", bg: "bg-violet-500/[0.05] border-violet-500/20" },
                  { element: "تاريخ النشر", source: "Auto — وقت الـ Publish", color: "text-sky-400", bg: "bg-sky-500/[0.05] border-sky-500/20" },
                  { element: "وقت القراءة التقديري", source: "Auto — من عدد الكلمات", color: "text-cyan-400", bg: "bg-cyan-500/[0.05] border-cyan-500/20" },
                  { element: "اسم المؤسسة (عيادات بلسم)", source: "Clients → Client Name", color: "text-amber-400", bg: "bg-amber-500/[0.05] border-amber-500/20" },
                ].map((row, i) => (
                  <div key={i} className={`rounded-lg border px-3 py-2 flex items-center justify-between gap-3 ${row.bg}`}>
                    <span className={`text-[10px] font-medium leading-snug ${row.color}`}>{row.element}</span>
                    <code className="text-[9px] bg-background/80 border border-border rounded px-1.5 py-0.5 shrink-0 whitespace-nowrap">{row.source}</code>
                  </div>
                ))}
              </div>
              <p className="text-[10px] text-muted-foreground mt-3 leading-relaxed">
                ✦ هذا يُسمّى <strong className="text-foreground">JSON-LD / Schema Markup</strong> — جوجل يقرأه خلف الكواليس ويُحوّله لهذه البطاقة. النظام يكتبه تلقائياً لكل مقال منشور.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-6 h-6 rounded-full bg-sky-500/20 border border-sky-500/40 flex items-center justify-center text-[10px] font-bold text-sky-400 shrink-0">٣</span>
            ...
            <div>
              ...
              <div className="rounded-xl border border-red-500/25 bg-background p-4 space-y-2">
                <div className="flex items-center gap-1.5 border-s-2 border-red-500/30 ps-2">
                  ...
                  <span className="text-[10px] text-muted-foreground/60">modonty.com › articles › post-4821</span>
                </div>
              ...
              <div className="mt-3 space-y-1.5">
                <div className="flex items-start gap-1.5">
                  ...
                  <p className="text-[10px] text-muted-foreground">رابط بأرقام عشوائية — جوجل لا يفهم موضوع الصفحة</p>
                </div>
                <div className="flex items-start gap-1.5">
                  <XCircle className="h-3 w-3 text-red-400 mt-0.5 shrink-0" />
                  <p className="text-[10px] text-muted-foreground">عنوان عام بلا كلمة مفتاحية — لا يظهر في نتائج البحث المستهدفة</p>
                </div>
                <div className="flex items-start gap-1.5">
                  <XCircle className="h-3 w-3 text-red-400 mt-0.5 shrink-0" />
                  <p className="text-[10px] text-muted-foreground">وصف اختاره جوجل بنفسه من أول سطر — لا يُقنع أحداً بالنقر</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="rounded-xl border border-emerald-500/25 bg-background p-4 space-y-2">
                <div className="flex items-center gap-1.5 border-s-2 border-sky-500 ps-2">
                  ...
                  <span className="text-[10px] text-emerald-500">modonty.com › عيادات-بلسم › رعاية-ما-بعد-العملية</span>
                </div>
              ...
              <div className="mt-3 space-y-1.5">
                <div className="flex items-start gap-1.5">
                  ...
                  <p className="text-[10px] text-muted-foreground">رابط بكلمات مفتاحية — جوجل يفهم الموضوع ويُصنّف الصفحة صح</p>
                </div>
                <div className="flex items-start gap-1.5">
                  <CheckCircle2 className="h-3 w-3 text-emerald-400 mt-0.5 shrink-0" />
                  <p className="text-[10px] text-muted-foreground">عنوان يحوي الكلمة المفتاحية + اسم البراند — يُقنع بالنقر</p>
                </div>
                <div className="flex items-start gap-1.5">
                  <CheckCircle2 className="h-3 w-3 text-emerald-400 mt-0.5 shrink-0" />
                  <p className="text-[10px] text-muted-foreground">وصف مكتوب خصيصاً بكلمة مفتاحية + CTA — يرفع الـ CTR فوراً</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-5">
            <span className="w-6 h-6 rounded-full bg-sky-500/20 border border-sky-500/40 flex items-center justify-center text-[10px] font-bold text-sky-400 shrink-0">٤</span>
          ...
          <div className="flex items-center gap-2 mb-6 flex-wrap">
            {(
              [
                ...
                { label: "النظام", sub: "يُولّد OG Tags", c: "border-violet-500/30 bg-violet-500/[0.08] text-violet-400" },
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-muted-foreground">معاينة الرابط في المحادثة</p>
                </div>
              </div>
              <div className="rounded-2xl border border-[#25D366]/20 overflow-hidden" style={{ backgroundColor: "#0d1117" }}>
                <div className="px-3 py-2 flex items-center gap-2.5" style={{ backgroundColor: "#1f2c34" }}>
                  <div className="w-7 h-7 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#25D36630" }}>
                    <span className="text-[9px] font-bold" style={{ color: "#25D366" }}>ب</span>
                  </div>
                  <div>
                    <p className="text-[10px] font-medium text-white/90">عيادات بلسم الطبية</p>
                    <p className="text-[8px] text-white/40">آخر ظهور الآن</p>
                  </div>
                </div>
                <div className="p-3 space-y-2" style={{ backgroundColor: "#0d1117" }}>
                  <div className="flex justify-start">
                    <div className="text-[9px] text-white/60 rounded-lg px-2.5 py-1.5" style={{ backgroundColor: "#1f2c34" }}>
                  ...
                  <div className="flex justify-end">
                    <div className="rounded-xl overflow-hidden max-w-[88%]" style={{ backgroundColor: "#005c4b" }}>
                      <div className="aspect-[1.91/1] relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-sky-900 via-slate-800 to-violet-900 flex items-center justify-center">
                          <div className="text-center px-3">
                            <p className="text-[10px] font-bold text-white/90 leading-snug">رعاية ما بعد</p>
                            <p className="text-[10px] font-bold text-white/90">العملية الجراحية</p>
                      ...
                      <div className="px-2.5 py-2 border-t border-white/5 space-y-0.5">
                        <p className="text-[9px] font-semibold text-white/90 leading-snug">رعاية ما بعد العملية | بلسم</p>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-muted-foreground">مشاركة في التغذية الإخبارية</p>
                </div>
              </div>
              <div className="rounded-xl border border-border/60 bg-card overflow-hidden">
                <div className="px-3 py-2.5 flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[10px] font-semibold">Modonty</p>
                    <p className="text-[8px] text-muted-foreground">منصة إدارة المحتوى · للتو</p>
                  </div>
                </div>
                <div className="px-3 pb-2">
                  <p className="text-[10px] text-muted-foreground">نشرنا مقالاً جديداً حول رعاية ما بعد العملية 🏥</p>
                </div>
                <div className="border-t border-border/40">
                  <div className="aspect-[1200/627] relative">
                    <div className="absolute inset-0 bg-gradient-to-br from-sky-900/60 via-slate-800/80 to-violet-900/60 flex items-center justify-center">
                      <div className="text-center px-6">
                        ...
                        <p className="text-[10px] text-white/50 mt-1.5">عيادات بلسم الطبية</p>
                      </div>
                    </div>
                  ...
                  <div className="px-3 py-2.5 bg-muted/20">
                    <p className="text-[9px] text-muted-foreground/60 uppercase tracking-wide mb-1">modonty.com</p>
                    <p className="text-[11px] font-semibold leading-snug">رعاية ما بعد العملية الجراحية | عيادات بلسم الطبية</p>
                    <p className="text-[9px] text-muted-foreground mt-0.5 leading-relaxed">دليل شامل للتعافي بعد العملية — تعليمات التغذية والأدوية وعلامات التعافي الطبيعي...</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-6 h-6 rounded-full bg-foreground flex items-center justify-center shrink-0">
                  <span className="text-[9px] font-black text-background">𝕏</span>
                </div>
                <div>
                  <p className="text-xs font-bold">Twitter / X</p>
                  <p className="text-[9px] text-muted-foreground">Twitter Card — Large Image</p>
                </div>
              </div>
              <div className="rounded-xl border border-border/60 bg-card overflow-hidden">
                <div className="px-3 py-2.5 flex items-center gap-2">
                ...
                <div className="px-3 pb-2">
                  <p className="text-[10px] text-foreground/80">مقال جديد على المدونة 👇 قراءة إلزامية لكل مريض ✅</p>
                </div>
                  ...
                  <div className="aspect-[2/1] relative">
                    <div className="absolute inset-0 bg-gradient-to-br from-sky-900/50 via-slate-800/80 to-violet-900/50 flex items-center justify-center">
                      <div className="text-center px-4">
                        ...
                        <p className="text-[10px] text-white/40 mt-1">عيادات بلسم الطبية</p>
                      </div>
                    </div>
                    <span className="absolute bottom-2 end-2 text-[7px] text-white/20">OG Image · 1200×600</span>
                  </div>
                  <div className="px-3 py-2 bg-muted/20">
                    <p className="text-[10px] font-semibold leading-snug">رعاية ما بعد العملية | بلسم الطبية</p>
                    <p className="text-[9px] text-muted-foreground mt-0.5">دليل شامل للتعافي بعد العملية الجراحية...</p>
          ...
          <div className="rounded-xl border border-border/50 overflow-hidden mb-5">
            ...
            <div className="divide-y divide-border/30">
              {(
                [
                  { element: "الصورة الكبيرة", field: "Articles → صورة المقال (1200×630px)", note: "نفس الصورة في كل المنصات", dot: "bg-sky-500" },
                  { element: "العنوان داخل البطاقة", field: "Articles → SEO Title", note: "50-60 حرف · يُقطَع إذا أطول", dot: "bg-violet-500" },
                  { element: "الوصف تحت العنوان", field: "Articles → SEO Description", note: "140-160 حرف · بعض المنصات تُقصّره", dot: "bg-amber-500" },
                  { element: "اسم الدومين", field: "Auto — من رابط الموقع", note: "لا يحتاج إدخال يدوي", dot: "bg-emerald-500" },
                  { element: "اسم الموقع", field: "Settings → Site Name", note: "يُستخدم في LinkedIn + Breadcrumb", dot: "bg-pink-500" },
                ] as const
              ).map((row, i) => (
                <div key={i} className="flex items-center gap-3 px-4 py-2.5 flex-wrap">
                  ...
                  <span className="text-[10px] font-medium w-36 shrink-0">{row.element}</span>
                  <code className="text-[9px] bg-muted border border-border rounded px-1.5 py-0.5 shrink-0">{row.field}</code>
                  <span className="text-[9px] text-muted-foreground hidden sm:block">{row.note}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-bold text-red-400">بدون OG Image</span>
              </div>
              <div className="rounded-xl border border-red-500/20 bg-card overflow-hidden">
                <div className="w-full h-20 bg-muted/40 flex flex-col items-center justify-center gap-1 border-b border-border/30">
                  ...
                  <p className="text-[9px] text-muted-foreground/35">لا توجد صورة</p>
                </div>
                <div className="px-3 py-2">
                  <p className="text-[10px] text-muted-foreground/60">مقال جديد — عيادات بلسم الطبية</p>
                  <p className="text-[9px] text-muted-foreground/40 mt-0.5">modonty.com</p>
                </div>
              </div>
              <div className="mt-2 space-y-1">
                <p className="text-[10px] text-muted-foreground flex items-start gap-1.5"><XCircle className="h-3 w-3 text-red-400 shrink-0 mt-0.5" />لا صورة = نقرات أقل بـ ٣-٥× في وسائل التواصل</p>
                <p className="text-[10px] text-muted-foreground flex items-start gap-1.5"><XCircle className="h-3 w-3 text-red-400 shrink-0 mt-0.5" />المنصة تختار صورة عشوائية من الصفحة</p>
                <p className="text-[10px] text-muted-foreground flex items-start gap-1.5"><XCircle className="h-3 w-3 text-red-400 shrink-0 mt-0.5" />يبدو غير احترافي ويخسر الثقة فوراً</p>
              </div>
            </div>
            <div>
              <div className="flex items-center gap-2 mb-2">
                <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400 shrink-0" />
                <span className="text-xs font-bold text-emerald-400">مع OG Image (1200×630px)</span>
              </div>
              <div className="rounded-xl border border-emerald-500/20 bg-card overflow-hidden">
                <div className="w-full h-20 bg-gradient-to-br from-sky-900/40 via-slate-800/60 to-violet-900/40 flex flex-col items-center justify-center gap-0.5 border-b border-border/30">
                  <p className="text-[10px] font-bold text-white/80">رعاية ما بعد العملية</p>
                  <p className="text-[8px] text-white/40">عيادات بلسم الطبية</p>
                </div>
                <div className="px-3 py-2">
                  <p className="text-[10px] font-semibold">رعاية ما بعد العملية | بلسم الطبية</p>
                  <p className="text-[9px] text-muted-foreground mt-0.5">modonty.com</p>
                </div>
              </div>
              <div className="mt-2 space-y-1">
                <p className="text-[10px] text-muted-foreground flex items-start gap-1.5"><CheckCircle2 className="h-3 w-3 text-emerald-400 shrink-0 mt-0.5" />صورة جاذبة = أكثر نقرات ومشاركات</p>
                <p className="text-[10px] text-muted-foreground flex items-start gap-1.5"><CheckCircle2 className="h-3 w-3 text-emerald-400 shrink-0 mt-0.5" />براند الموقع يظهر في كل مشاركة</p>
                <p className="text-[10px] text-muted-foreground flex items-start gap-1.5"><CheckCircle2 className="h-3 w-3 text-emerald-400 shrink-0 mt-0.5" />تجربة احترافية تبني الثقة بالمحتوى</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-sky-500/25 bg-gradient-to-r from-sky-500/[0.07] via-violet-500/[0.04] to-emerald-500/[0.07] p-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
              {(
                [
                  { label: "Slug", sub: "رابط جوجل", color: "text-sky-400" },
                  { label: "SEO Title", sub: "عنوان جوجل + المنصات", color: "text-violet-400" },
                  { label: "SEO Description", sub: "وصف جوجل + المنصات", color: "text-amber-400" },
                  { label: "صورة المقال", sub: "OG Image في كل المنصات", color: "text-pink-400" },
                  { label: "بيانات الكاتب والعميل", sub: "JSON-LD + Rich Result", color: "text-emerald-400" },
                ] as const
              ).map((item) => (

    ...
    rules: [
      {
        ...
        do: "حتى 80 حرفاً — ضع الكلمة المفتاحية في أوّله. هذا عنوان المقال عندنا، وعنوان جوجل حقل منفصل في الخطوة 3",
        dont: "لا تكتب عنواناً عاماً مثل «مقال جديد» — ولا تكرر نفس العنوان في مقالين",
      },
      {
        label: "Excerpt — ملخص المقال",
        do: "حوالي 155 حرفاً — يُستخرج من أول المقال تلقائياً، وهو البديل الاحتياطي لوصف السيو ووصف المشاركة لو تركتهما فارغين",
    ...
    rules: [
      {
        ...
        do: "حتى 51 حرفاً — النظام يضيف اسم المنصّة بعده فيصير 60 في جوجل، وهو الحدّ الذي يعرضه. يختلف عن عنوان المقال",
    ...
    rules: [
      {
        ...
        do: "اربط 3 مقالات على الأقل — هذا هو الحدّ الذي يعطي معيار «الربط الداخلي» علامته كاملة في نتيجة السيو",
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        icon: Search,
        required: true,
        fields: ["SEO Title (حتى 51 حرفاً)", "SEO Description (140-160 حرف)", "الكلمات المفتاحية", "الكلمات الدلالية"],

      ...
      <DialogContent className="sm:max-w-md">
        ...
        {step === "idle" && (
          <div className="space-y-4">
            ...
            <div className="rounded-md bg-yellow-50 border border-yellow-200 dark:bg-yellow-500/10 dark:border-yellow-500/20 px-3 py-2 text-[12px] text-yellow-700 dark:text-yellow-400" dir="rtl">

...
export default async function NewClientPage() {
  const [industries, siteUrl, countries, salesReps, editors] = await Promise.all([
    getIndustries(),
    loadSiteUrl(),
    getActiveCountries(),
    getSalesReps(),
  ...
  return (
    <div className="max-w-[1040px] mx-auto px-6 py-6">
      ...
      <CreateClientForm industries={industries} siteUrl={siteUrl} countries={countries} salesReps={salesReps} editors={editors} />
    </div>
  );
}

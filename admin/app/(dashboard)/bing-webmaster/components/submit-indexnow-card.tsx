...
import { submitAllToIndexNowAction } from "../actions/bing-actions";
...
export function SubmitIndexNowCard() {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center justify-between text-base">
          <span className="flex items-center gap-2">
            ...
            IndexNow — instant indexing across 5 engines
          </span>
          {last && (
      ...
      <CardContent className="space-y-3">
        <p className="text-sm text-muted-foreground">
          Pings IndexNow API with every URL in your sitemap.xml. Single click → Bing + Yandex + Brave + Seznam +
          Naver notified instantly (covers ChatGPT Search, Copilot, DuckDuckGo, Perplexity, Brave AI).
        </p>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                and sends every URL to Bing + Yandex + Brave + Seznam + Naver in a single request. Safe to re-run.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>

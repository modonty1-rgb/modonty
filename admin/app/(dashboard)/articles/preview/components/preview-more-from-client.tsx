...
interface PreviewMoreFromClientProps {
  articles: Article[];
  clientName: string;
}

export function PreviewMoreFromClient({ articles, clientName }: PreviewMoreFromClientProps) {
  if (!articles || articles.length === 0) return null;

  return (
    <section className="my-8 md:my-12" aria-labelledby="more-from-client-heading">
      <h2 id="more-from-client-heading" className="text-xl font-semibold mb-6">
        المزيد من العميل: {clientName}
      </h2>

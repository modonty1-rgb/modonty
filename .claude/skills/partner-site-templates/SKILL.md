...
sections      Json?    // [{ key:"about", enabled:true }, { key:"services", enabled:true }, ...]
```
...
2. **الأقسام:** قائمة الأقسام المتاحة في القالب بمفاتيح تشغيل وترتيب بالسحب؛ بجانب كل قسم **حالة بياناته** («ناقص: فيديو تعريفي — يرفع الثقة» · «جاهز»). نسبة اكتمال إجمالية.

...
export const ar = {
  ...
  nav: {
    ...
    // «الأسئلة الشائعة» وحدها كانت تُخلَط بـ«أسئلة صفحتك»: الأولى أسئلة تحت المقالات
    // (جدول `articleFAQ`)، والثانية أسئلة صفحة الموقع (`clientFAQ`). الاسم يذكر نطاقه.
    faqs: "أسئلة مقالاتك",
    clientComments: "آراء حول نشاطك",
    clientReviews: "تقييمات نشاطك",
    pageContent: "محتوى الموقع",
    gallery: "معرض الصور",
    reels: "الريلز",
    videos: "الفيديوهات",
    pageFaq: "أسئلة صفحتك",
  ...
  articles: {
    ...
    scheduledHint: "وافقتَ على المقالة — المحرر سيختار موعد النشر قريباً.",
    ...
    approveConfirm: "تأكيد الموافقة على المقالة؟ المحرر سيقوم بنشرها بعد الموافقة.",
    approveSuccess: "تمت الموافقة — المحرر سيقوم بالنشر قريباً",
    approveFailed: "ما تمت الموافقة على المقالة. جرّب مرة أخرى.",
    requestSuccess: "تم إرسال طلب التعديلات للمحرر",
  ...
  media: {
    ...
    emptyLogo: "لم يتم تحديد شعار لنشاطك بعد. عند رفع شعارك، سيظهر هنا.",
    emptyPost: "لا توجد صور مقالات بعد. عند نشر مقالات، ستظهر صورها هنا.",
    emptyCover: "لم تُحدَّد صورة غلاف لصفحة نشاطك على مودونتي بعد. عند ربط الصورة، ستظهر هنا.",
  ...
  bookings: {
    title: "الحجوزات",
    subtitle: "كل طلبات الحجز اللي وصلتك من زرّ «احجز الآن» — تابعها وغيّر حالتها.",
    pageHint:
      "لما زائر يعبّي فورم الحجز في مقالك أو صفحتك، يوصلك هنا فوراً (وعلى تيليجرام لو مربوط). كلّم العميل، وعلّم الحالة عشان ما يضيع أحد.",
    new: "جديد",
    contacted: "تواصلت",
    done: "تم",
    archived: "مؤرشف",
    total: "الكل",
    newHint: "وصل ولسّا ما تواصلت",
    contactedHint: "تواصلت معه",
    doneHint: "خلّصت الحجز",
    archivedHint: "مؤرشف",
    totalHint: "كل الطلبات",
    searchPlaceholder: "ابحث بالاسم أو الجوال أو الرسالة…",
    all: "الكل",
    selected: "محدد",
    bulkContacted: "علّم: تواصلت",
    bulkArchive: "أرشفة",
    bulkDelete: "حذف",
    clearSelection: "إلغاء التحديد",
    selectAll: "تحديد الكل",
    showing: "عرض",
    of: "من",
    restoreNew: "رجّعه جديد",
    markContacted: "تواصلت",
    markDone: "تم",
    markArchived: "أرشفة",
    delete: "حذف",
    noBookings: "ما في حجوزات بعد",
    emptyHint: "أول ما يوصلك طلب حجز، بيظهر هنا.",
    noMatchSearch: "ما في نتائج للبحث.",
    noBookingsFiltered: "ما في حجوزات بهذي الحالة.",
    ...
    callBtn: "اتصال",
    mailBtn: "إيميل",
    preferredAt: "الموعد المفضّل",
    noPreferred: "ما حدّد موعد",
    messageLabel: "الرسالة",
    noMessage: "بدون رسالة",
    sourceLabel: "المصدر",
    articleLabel: "المقال",
    timeline: "التفاصيل الزمنية",
    createdAt: "وصل في",
    ipAddress: "IP",
    userAgent: "المتصفح",
    confirm: "تأكيد",
    ...
    deleteConfirm: "متأكد تبغى تحذف هذا الطلب؟",
    deleteSuccess: "تم الحذف",
    deleteFailed: "تعذّر الحذف",
    bulkUpdateSuccess: "تم تحديث الطلبات المحددة",
    bulkDeleteConfirm: "متأكد تبغى تحذف الطلبات المحددة؟",
    bulkDeleteSuccess: "تم حذف الطلبات المحددة",
    statusBadge: { new: "جديد", contacted: "تواصلت", done: "تم", archived: "مؤرشف" },
    sourceMap: {
      article_dock: "من المقال (الجوال)",
      article_card: "من كارت العميل",
  ...
  profile: {
    ...
    description: "تعديل بيانات النشاط والتواصل",
    ...
    slogan: "الشعار",
    organizationDescription: "وصف النشاط",
    ...
    addressAdditionalNumber: "الرقم الإضافي (العنوان الوطني)",
    addressAdditionalNumberHint: "4 أرقام تُكمّل رقم المبنى لتحديد الموقع بدقّة",
    saudiGulf: "السجل التجاري والضرائب",
    commercialRegistrationNumber: "رقم السجل التجاري",
    vatID: "رقم ضريبة القيمة المضافة (VAT)",
    vatIDHint: "15 رقم يبدأ وينتهي بـ 3",
    taxID: "الرقم المميز / المعرّف الضريبي (TIN)",

  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Physical positioning to MATCH the physical slide animation (RTL-safe):
        // logical end-0/start-0 mixed with physical slide-from-right/left caused the
        // panel to settle on the opposite side from where it animated in.
        side === "right" &&
